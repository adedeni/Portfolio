        ...
        <div class="container-fluid p-0">
            <div class="row g-0">
                <div class="col-lg-4 col-sm-6">
                    <a class="portfolio-box" href="https://mobilenig.com" title="Mobilenig Website">
                        <img class="img-fluid" src="assets\img\portfolio\thumbnails\mobilenig.png" alt="..." />
                        <div class="portfolio-box-caption">
                            <div class="project-category text-white-50">Websites</div>
                            <div class="project-name">Mobilenig Website</div>
                        </div>
                    </a>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <a class="portfolio-box" href="https://naira4coin.com" title="Project Name">
                        <img class="img-fluid" src="assets\img\portfolio\thumbnails\naira4coin.png" alt="..." />
                        <div class="portfolio-box-caption">
                            <div class="project-category text-white-50">Websites</div>
                            <div class="project-name">Naira4coin Website</div>
                        </div>
                    </a>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <a class="portfolio-box" href="https://easil.com.ng" title="Project Name">
                        <img class="img-fluid" src="assets\img\portfolio\thumbnails\easil.png" alt="..." />
                        <div class="portfolio-box-caption">
                            <div class="project-category text-white-50">Websites</div>
                            <div class="project-name">Easil Website</div>
                        </div>
                    </a>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <a class="portfolio-box" href="https://easil.com.ng/apps/swappay" title="Project Name">
                        <img class="img-fluid" src="assets\img\portfolio\thumbnails\swappay.png" alt="..." />
                        <div class="portfolio-box-caption">
                            <div class="project-category text-white-50">Mobile App</div>
                            <div class="project-name">SWapPay App</div>
                        </div>
                    </a>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <a class="portfolio-box" href="https://easil.com.ng/apps/ushopia" title="Project Name">
                        <img class="img-fluid" src="assets\img\portfolio\thumbnails\ushopia.png" alt="..." />
                        <div class="portfolio-box-caption">
                            <div class="project-category text-white-50">Mobile App</div>
